...
| new var new_format is responsible for default output format
|===============================================================
*/
class CI_Image_lib {
...
//		$file_ext = $xp['ext'];
		...
		@mkdir($this->dest_folder.$this->thumb_marker."/");	
...
//		$this->full_dst_path = $this->dest_folder.$filename.$this->thumb_marker.$file_ext;
	...
	{	
		if($this->new_format) $this->image_type = $this->new_format;
		switch ($this->image_type)
		{
			case 1 :
